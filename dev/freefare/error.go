...
// expect to not see OPERATION_OK anywhere.  Error codes CryptoError,
// TagInfoMissing, and UnknownTagType are generated by the library only.
const (
	OperationOK         = 0x00
	CryptoError         = 0x01
	NoChanges           = 0x0C
...
const (
	...
	OverflowError    // EOVERFLOW supplied by KeyDeriver methods
)
...
var errorStrings = map[Error]string{
	...
	TagInfoMissing:      "tag info missing",
	...
	MadVersionNotSup: "MAD version not supported",
	OverflowError:    "key data overflow",
}
